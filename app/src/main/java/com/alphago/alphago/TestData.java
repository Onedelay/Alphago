...
public class TestData {
    ...
    // image는 어떻게 저장하지
    public static String dataLabel[] = {"dog","cat","lion","apple","banana","strawberry","lemon","bed","chair","desk","tomato","bean","cucumber","potato","pumpkin"};
    public static String dataCat[] = {"animal","animal","animal","fruit","fruit","fruit","fruit","furniture","furniture","furniture","vegetable","vegetable","vegetable","vegetable","vegetable"};
