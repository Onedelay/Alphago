...
public class GameWordActivity extends NoStatusBarActivity {
    ...
    private Button btn_wordgame_exit;
    private Button btn_wordgame_next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_wordgame_exit = (Button)findViewById(R.id.btn_wordgame_exit);
        btn_wordgame_next = (Button)findViewById(R.id.btn_wordgame_next);
        ...
        btn_wordgame_exit.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_wordgame_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
